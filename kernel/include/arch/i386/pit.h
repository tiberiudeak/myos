 ...
 * 		access mode, 10 = hibyte only access mode, 11 = lobyte/hibyte access
 * mode M: mode; M2 M1 M0: 000 = mode 0, 001 = mode 1, X10 = mode 2, X11 = code
 * 3, 100 = mode 4, 101 = mode 5 BCD: 0 = binary counter 16 bits, 1 = binary
